...
train_list = get_split_list("F:\\zIMseg\\pointcloud\\partanno_train_test_val\\train_test_split\\shuffled_test_file_list.json")
...
for kkk in range(len(class_name_list)):
	...
	#name of output file
	hdf5_path = class_name_list[kkk]+'\\'+class_name+'_test_vox.hdf5'

	#obj_list
	fout = open(class_name_list[kkk]+'\\obj_test_list.txt','w',newline='')
